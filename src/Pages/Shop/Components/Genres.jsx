...
export default function Sidebar({ setResults, setGenre }) {
  return (
    <aside className="flex flex-col sticky top-[88px] h-full" style={{ minWidth: '232px'  }}>
      <div className="flex flex-col items-start ml-8">
        ...
        <Heading title="Past Month" dates="&dates=2023-08-31,2023-09-30" img="/genres/topmonthly.svg" setResults={setResults} setGenre={setGenre}></Heading>
